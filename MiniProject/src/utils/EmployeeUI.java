...
public class EmployeeUI {
	...
	public void printFunction() {
		RenderSystem.printTitle(RenderSystem.WIDTH, "직원 관리 시스템");
		System.out.println(
				" 1. 새로운 직원 정보 등록하기\n"
				+ " 2. 전체 직원 정보 조회하기\n"
				+ " 3. 직원 정보 수정하기\n"
	...
	public void insertEmployee(Connection con, Scanner read) {
		try {
			...
			while (true) {
				// 제목 출력
				RenderSystem.printTitle(RenderSystem.WIDTH, "신규 직원 등록하기");
				
				// 직원 이름 입력받기
				RenderSystem.printInputFormMessage("직원의 이름을 입력해주세요.");
				inputName = read.nextLine();
				RenderSystem.printEmptyLine(2);

				// 직원 전화번호 입력받기
				RenderSystem.printInputFormMessage("직원의 전화번호를 입력해주세요.");
				inputPhoneNumber = read.nextLine();
				RenderSystem.printEmptyLine(2);
				
				// 직원 직급 입력받기 (점장, 매니저, 알바를 제외한 입력값은 재입력)
				while (true) {
					RenderSystem.printTitle(RenderSystem.WIDTH, "신규 직원 등록하기 - 직급 종류");
					System.out.println("\u2714 점장");
					System.out.println("\u2714 매니저");
					System.out.println("\u2714 알바");
					RenderSystem.printDivider(RenderSystem.WIDTH, true);
					RenderSystem.printInputFormMessage("직원의 직급을 입력헤주세요.");
				...
				// 직원 급여 입력받기
				RenderSystem.printInputFormMessage("직원의 급여를 입력해주세요.");
				inputSalary = read.nextLine();
				RenderSystem.printEmptyLine(2);
				
				// 입력한 모든 정보 출력하기
				RenderSystem.printTitle(RenderSystem.WIDTH, "입력한 직원정보");
				...
				RenderSystem.printInputFormMessage("입력하신 정보가 맞으시면 'y'를 입력해주세요.");
	...
	public void getEmployeeAll(Connection con, Scanner read) {
		try {
			...
			// 부제목 출력
			RenderSystem.printSubTitle(RenderSystem.WIDTH, "전체 직원정보 조회");
			...
			// 조회 종료 여부 입력받기
			while (true) {
				RenderSystem.printInputFormMessage("직원 조회가 성공적으로 이루어졌습니다. 확인을 마치셨으면 'Q'를 입력해주세요.");
	...
	public void updateEmployee(Connection con, Scanner read) {
		try {
			...
			while (true) {
				// 제목 출력
				RenderSystem.printTitle(RenderSystem.WIDTH, "직원 정보 수정 - 수정할 직원 선정");
				
				// 수정할 직원 아이디 입력받기
				RenderSystem.printInputFormMessage("수정할 직원의 아이디를 입력해주세요. ( Q : 이전으로 , R : 직원 ID 조회하기 )");
				...
				// 선택한 직원의 수정 범위 선택하기
				RenderSystem.printSubTitle(RenderSystem.WIDTH, "직원 정보 수정 - 수정할 내용 선택");
				...
				while (true) {
					// 수정 범위 입력받기
					RenderSystem.printInputFormMessage("직원의 수정할 부분을 선택해주세요.");
					...
					case "1":
						// 수정할 이름 입력받기
						RenderSystem.printInputFormMessage("수정할 이름을 입력해주세요.");
					...
					case "2":
						// 수정할 전화번호 입력받기
						RenderSystem.printInputFormMessage("수정할 전화번호를 입력해주세요.");
					...
					case "3":
						// 수정할 급여 입력받기
						RenderSystem.printInputFormMessage("수정할 급여를 입력해주세요.");
					...
					case "4":
						// 수정할 직급 입력받기
						RenderSystem.printInputFormMessage("수정할 직급을 입력해주세요.");
	...
	public void deleteEmployee(Connection con, Scanner read) {
		try {
			while (true) {
				// 제목 출력하기
				RenderSystem.printTitle(RenderSystem.WIDTH, "직원 정보 삭제 - 삭제할 직원 선정");
				
				// 삭제할 직원 아이디 입력받기
				RenderSystem.printInputFormMessage("삭제할 직원의 아이디를 입력해주세요. (Q: 이전으로, R: 직원 ID 조회하기)");
				String targetId = read.nextLine();
				RenderSystem.printEmptyLine(2);
